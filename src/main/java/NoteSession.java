...
public class NoteSession {
    ...
    public NoteSession(String username, String[] noteTitles, String[] noteBodies, DatabaseManager database) {
    ...
    private void refreshNotes() {
        NoteSession updatedNs = database.getUserNoteSession(username);
        noteTitles = updatedNs.getNoteTitles();
        noteBodies = updatedNs.getNoteBodies();
    }
